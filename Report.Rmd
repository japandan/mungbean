...
I would like to prove that the study was correct by showing the difference in length from 24 hours -> 120 hours and calculating the %percentage increase at each temp.  To do this, I will change the starting weight in the data to 1 for each sample and we can then calculate the %change from hour 24 until hour 120.
...
>increased  with increasing  duration .  Sprout length  and fresh weights  were  highest  between  96
>and >120  hours. However, sprout dry weights  were highest between  24 and  48  hours  after setting  the test.
